        ...
        <main>
            ...
            <div class="tabela_meio">
                ...
                <table>
                    ...
                    <tr>
                        <form method="post" action="php/peditarcliente.php">
                            <td>
                                <input type="hidden" name="cod_cliente" value="<?= $usuario['cod_cliente']; ?>" />
                                <label>
                                    <input type="text" name="nome_cliente" value="<?= $usuario['nome_cliente']; ?>" />
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type="text" name="telefone_cliente" value="<?= $usuario['telefone_cliente']; ?>" />
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type="text" name="tipo_cliente" value="<?= $usuario['tipo_cliente']; ?>" />
                                </label>
                            </td>
                            <br>
                            <td>
                                <label>
                                    <input type="text" name="email_cliente" value="<?= $usuario['email_cliente']; ?>" />
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type="password" name="senha_cliente" value="<?= $usuario['senha_cliente']; ?>" />
                                </label>
                            </td>
                            <td>
