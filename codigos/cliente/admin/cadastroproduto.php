...
if(isset($_post['salvar'])):
    ...
    if(in_array($extensao, $formatosPermitidos)):
        $pasta = "img/produtos/";
        $temporario = $_FILES['foto_produto']['tmp_name'];

        if(move_uploaded_file($temporario, $pasta.$novonome)):
            $mensagem = "Upload feito com sucesso";
        else:
            $mensagem = "Upload não concluído";
        endif;
    else:
...
<body>
    ...
    <!-- Começo da barra lateral de menu -->
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="cadastroproduto.php" class="active">
    ...
    <main>
        ...
        <div class="tabela_meio">
            <form method="POST" action="./php/pcadastroproduto.php">
            <label>
                Nome : <input type="text" name="nome_produto"/>
            </label>
            <label>
                Preço : <input type="float" name="preco_produto"/>
            </label>
            <label>
                Descrição : <input type="text" name="descricao_produto"/>
            </label>
            <label>
                Ativo : <input type="text" name="ativo_produto"/>
            </label>
            <label>
                Imagem : <input type="file" name="foto_produto"/>
            </label>
